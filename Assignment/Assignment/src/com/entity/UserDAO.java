...
public class UserDAO implements IUserDAO {
	...
	public List<User> findByName( String name ){
		EntityManagerHelper.log("finding TbMember instance with property: "
				+ name , Level.INFO, null);
		try {
			final String queryString = "from User where userName = :name";
			Query query = getEntityManager().createQuery(queryString).setParameter("name", name);
	...
	public List<User> findByActor(Object actor) {
		return findByProperty(ACTOR, actor);
	}

	public List<User> findByStudentId(Object studentId) {
