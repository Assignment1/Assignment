...
public class vemanagerOp {
	private String[] vemanagerValue;
	...
	public String[] getVemanagerValue() {
		return vemanagerValue;
	}

	public void setVemanagerValue(String[] vemanagerValue) {
		this.vemanagerValue = vemanagerValue;
	}
	...
	private void cancel(){
		...
		for(String managerId : vemanagerValue){
			manager = iuserdao.findById(Integer.parseInt(managerId));
			manager.setVerification("0");
